...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__24742 = cljs.core.instance_QMARK_;
var expr__24743 = reactive_val;
if(cljs.core.truth_(pred__24742.call(null,reagent.ratom.RAtom,expr__24743))){
return "ra";
} else {
if(cljs.core.truth_(pred__24742.call(null,reagent.ratom.RCursor,expr__24743))){
return "rc";
} else {
if(cljs.core.truth_(pred__24742.call(null,reagent.ratom.Reaction,expr__24743))){
return "rx";
} else {
if(cljs.core.truth_(pred__24742.call(null,reagent.ratom.Track,expr__24743))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1518565229505
