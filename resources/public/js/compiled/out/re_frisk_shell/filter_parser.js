...
var G__28744 = cljs.tools.reader.reader_types.peek_char.call(null,rdr);
...
var vec__28745 = clojure.string.split.call(null,s,/\s+/,(2));
var prefix = cljs.core.nth.call(null,vec__28745,(0),null);
var rest = cljs.core.nth.call(null,vec__28745,(1),null);
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"val","val",128701612),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"free","free",801364328),prefix], null),new cljs.core.Keyword(null,"rest","rest",-1241696419),(function (){var or__7668__auto__ = rest;
...
try{var map__28749 = re_frisk_shell.filter_parser.read_string_SINGLEQUOTE_.call(null,s);
...
var foo = map__28749__$1;
var val = cljs.core.get.call(null,map__28749__$1,new cljs.core.Keyword(null,"val","val",128701612));
var rest = cljs.core.get.call(null,map__28749__$1,new cljs.core.Keyword(null,"rest","rest",-1241696419));
...
try{var map__28755 = re_frisk_shell.filter_parser.read_string_SINGLEQUOTE_.call(null,s);
...
var val = cljs.core.get.call(null,map__28755__$1,new cljs.core.Keyword(null,"val","val",128701612));
var rest = cljs.core.get.call(null,map__28755__$1,new cljs.core.Keyword(null,"rest","rest",-1241696419));
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"val","val",128701612),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"expr","expr",745722291),val], null),new cljs.core.Keyword(null,"rest","rest",-1241696419),rest], null);
}catch (e28751){var _ = e28751;
var vec__28752 = clojure.string.split.call(null,s,/\s+/,(2));
var prefix = cljs.core.nth.call(null,vec__28752,(0),null);
var rest = cljs.core.nth.call(null,vec__28752,(1),null);
var prefix__$1 = clojure.string.replace.call(null,prefix,/^\"/,"");
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"val","val",128701612),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"string-prefix","string-prefix",2091851734),prefix__$1], null),new cljs.core.Keyword(null,"rest","rest",-1241696419),(function (){var or__7668__auto__ = rest;
if(cljs.core.truth_(or__7668__auto__)){
return or__7668__auto__;
} else {
return "";
...
var G__28757 = cljs.core.first.call(null,s);
switch (G__28757) {
case "[":
case "(":
case "{":
...
var map__28759 = re_frisk_shell.filter_parser.parse_part.call(null,s__$2);
...
var val = cljs.core.get.call(null,map__28759__$1,new cljs.core.Keyword(null,"val","val",128701612));
var rest = cljs.core.get.call(null,map__28759__$1,new cljs.core.Keyword(null,"rest","rest",-1241696419));
...
//# sourceMappingURL=filter_parser.js.map?rel=1518565235391
