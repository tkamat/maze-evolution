...
var map__29948 = top_item;
var map__29948__$1 = ((((!((map__29948 == null)))?((((map__29948.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__29948.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__29948):map__29948);
...
}catch (e29947){var _e = e29947;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__4655__auto___29950 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___29950)){
var seen_errors_29951 = temp__4655__auto___29950;
if(cljs.core.truth_(seen_errors_29951.has(self))){
} else {
seen_errors_29951.add(self);

var temp__4657__auto___29952 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___29952)){
var sense_29953 = temp__4657__auto___29952;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_29953)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1518565236917
