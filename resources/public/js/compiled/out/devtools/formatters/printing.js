...
var len__29505__auto___40375 = arguments.length;
var i__29506__auto___40376 = (0);
while(true){
if((i__29506__auto___40376 < len__29505__auto___40375)){
args__29512__auto__.push((arguments[i__29506__auto___40376]));

var G__40377 = (i__29506__auto___40376 + (1));
i__29506__auto___40376 = G__40377;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__29513__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq40372){
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__40373,G__40374,seq40372__$2);
});
...
if(cljs.core.truth_((function (){var or__28334__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__28959__auto__,writer__28960__auto__,opt__28961__auto__){
return cljs.core._write.call(null,writer__28960__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__28322__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__28322__auto__){
var or__28334__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__28334__auto__)){
return or__28334__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__40378_SHARP_){
return !((cljs.core.meta.call(null,p1__40378_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__40379__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__28334__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e40383){var _e__38066__auto__ = e40383;
return false;
}})();
if(cljs.core.truth_(or__28334__auto__)){
return or__28334__auto__;
...
}catch (e40385){var _e__38066__auto__ = e40385;
return false;
}}
})())){
...
var _STAR_current_state_STAR_40387 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__40388 = opts;
...
var markup_db = cljs.core.get.call(null,map__40388__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_40387;
}});
...
;
var temp__4655__auto___40392 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___40392)){
var managed_print_level_40393 = temp__4655__auto___40392;
var _STAR_print_level_STAR_40391_40394 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_40393;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_40391_40394,managed_print_level_40393,temp__4655__auto___40392,writer,opts,job_fn){
return (function (p1__40390_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__40390_SHARP_,null);
});})(_STAR_print_level_STAR_40391_40394,managed_print_level_40393,temp__4655__auto___40392,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_40391_40394;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1517031120229
