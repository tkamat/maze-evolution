...
var len__8839__auto___24750 = arguments.length;
var i__8840__auto___24751 = (0);
while(true){
if((i__8840__auto___24751 < len__8839__auto___24750)){
args__8846__auto__.push((arguments[i__8840__auto___24751]));

var G__24752 = (i__8840__auto___24751 + (1));
i__8840__auto___24751 = G__24752;
continue;
} else {
}
break;
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq24747){
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__24748,G__24749,seq24747__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__24753_SHARP_){
return !((cljs.core.meta.call(null,p1__24753_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__24754__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e24758){var _e__22115__auto__ = e24758;
return false;
}})();
if(cljs.core.truth_(or__7668__auto__)){
return or__7668__auto__;
...
}catch (e24760){var _e__22115__auto__ = e24760;
return false;
}}
})())){
...
var _STAR_current_state_STAR_24762 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__24763 = opts;
...
var markup_db = cljs.core.get.call(null,map__24763__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_24762;
}});
...
;
var temp__4655__auto___24767 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___24767)){
var managed_print_level_24768 = temp__4655__auto___24767;
var _STAR_print_level_STAR_24766_24769 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_24768;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_24766_24769,managed_print_level_24768,temp__4655__auto___24767,writer,opts,job_fn){
return (function (p1__24765_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__24765_SHARP_,null);
});})(_STAR_print_level_STAR_24766_24769,managed_print_level_24768,temp__4655__auto___24767,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_24766_24769;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1518565229596
