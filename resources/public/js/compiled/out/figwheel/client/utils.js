...
return (new CustomEvent(event_name,(function (){var obj40542 = {"detail":data};
return obj40542;
})()));
} else {
...
var f = (function (){var pred__40549 = cljs.core._EQ_;
var expr__40550 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__40549.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__40550))){
return ((function (pred__40549,expr__40550){
return (function (p1__40543_SHARP_){
return console.warn(p1__40543_SHARP_);
});
;})(pred__40549,expr__40550))
} else {
if(cljs.core.truth_(pred__40549.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__40550))){
return ((function (pred__40549,expr__40550){
return (function (p1__40544_SHARP_){
return console.debug(p1__40544_SHARP_);
});
;})(pred__40549,expr__40550))
} else {
if(cljs.core.truth_(pred__40549.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__40550))){
return ((function (pred__40549,expr__40550){
return (function (p1__40545_SHARP_){
return console.error(p1__40545_SHARP_);
});
;})(pred__40549,expr__40550))
} else {
return ((function (pred__40549,expr__40550){
return (function (p1__40546_SHARP_){
return console.log(p1__40546_SHARP_);
});
;})(pred__40549,expr__40550))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__40553){
...
var opts = map__40554__$1;
var eval_fn = cljs.core.get.call(null,map__40554__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__40556_SHARP_);
});})(new_def))
);
...
return (function (p__40557){
var vec__40558 = p__40557;
var ky = cljs.core.nth.call(null,vec__40558,(0),null);
var v = cljs.core.nth.call(null,vec__40558,(1),null);
...
}catch (e40563){if((e40563 instanceof Error)){
var e = e40563;
return not_found;
} else {
throw e40563;
...
//# sourceMappingURL=utils.js.map?rel=1518645797488
