...
return (new CustomEvent(event_name,(function (){var obj49261 = {"detail":data};
return obj49261;
})()));
} else {
...
var f = (function (){var pred__49268 = cljs.core._EQ_;
var expr__49269 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__49268.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__49269))){
return ((function (pred__49268,expr__49269){
return (function (p1__49262_SHARP_){
return console.warn(p1__49262_SHARP_);
});
;})(pred__49268,expr__49269))
} else {
if(cljs.core.truth_(pred__49268.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__49269))){
return ((function (pred__49268,expr__49269){
return (function (p1__49263_SHARP_){
return console.debug(p1__49263_SHARP_);
});
;})(pred__49268,expr__49269))
} else {
if(cljs.core.truth_(pred__49268.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__49269))){
return ((function (pred__49268,expr__49269){
return (function (p1__49264_SHARP_){
return console.error(p1__49264_SHARP_);
});
;})(pred__49268,expr__49269))
} else {
return ((function (pred__49268,expr__49269){
return (function (p1__49265_SHARP_){
return console.log(p1__49265_SHARP_);
});
;})(pred__49268,expr__49269))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__49272){
var map__49273 = p__49272;
...
var opts = map__49273__$1;
var eval_fn = cljs.core.get.call(null,map__49273__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__49275_SHARP_);
});})(new_def))
);
...
return (function (p__49276){
var vec__49277 = p__49276;
var ky = cljs.core.nth.call(null,vec__49277,(0),null);
var v = cljs.core.nth.call(null,vec__49277,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1518330186080
