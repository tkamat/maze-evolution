...
var or__28334__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj35743 = {"detail":data};
return obj35743;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__28322__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__28322__auto__)){
var and__28322__auto____$1 = goog.object.get(window,"CustomEvent");
...
var f = (function (){var pred__35750 = cljs.core._EQ_;
var expr__35751 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__35750.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__35751))){
return ((function (pred__35750,expr__35751){
return (function (p1__35744_SHARP_){
return console.warn(p1__35744_SHARP_);
});
;})(pred__35750,expr__35751))
} else {
if(cljs.core.truth_(pred__35750.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__35751))){
return ((function (pred__35750,expr__35751){
return (function (p1__35745_SHARP_){
return console.debug(p1__35745_SHARP_);
});
;})(pred__35750,expr__35751))
} else {
if(cljs.core.truth_(pred__35750.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__35751))){
return ((function (pred__35750,expr__35751){
return (function (p1__35746_SHARP_){
return console.error(p1__35746_SHARP_);
});
;})(pred__35750,expr__35751))
} else {
return ((function (pred__35750,expr__35751){
return (function (p1__35747_SHARP_){
return console.log(p1__35747_SHARP_);
});
;})(pred__35750,expr__35751))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__35754){
...
var eval_fn = cljs.core.get.call(null,map__35755__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__35757_SHARP_);
});})(new_def))
);
...
return (function (p__35758){
var vec__35759 = p__35758;
var ky = cljs.core.nth.call(null,vec__35759,(0),null);
...
if(cljs.core.truth_((function (){var and__28322__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1517031114065
