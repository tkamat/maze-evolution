...
var or__36308__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj37979 = {"detail":data};
return obj37979;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__36296__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__36296__auto__)){
var and__36296__auto____$1 = goog.object.get(window,"CustomEvent");
...
var f = (function (){var pred__37986 = cljs.core._EQ_;
var expr__37987 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__37986.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__37987))){
return ((function (pred__37986,expr__37987){
return (function (p1__37980_SHARP_){
return console.warn(p1__37980_SHARP_);
});
;})(pred__37986,expr__37987))
} else {
if(cljs.core.truth_(pred__37986.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__37987))){
return ((function (pred__37986,expr__37987){
return (function (p1__37981_SHARP_){
return console.debug(p1__37981_SHARP_);
});
;})(pred__37986,expr__37987))
} else {
if(cljs.core.truth_(pred__37986.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__37987))){
return ((function (pred__37986,expr__37987){
return (function (p1__37982_SHARP_){
return console.error(p1__37982_SHARP_);
});
;})(pred__37986,expr__37987))
} else {
return ((function (pred__37986,expr__37987){
return (function (p1__37983_SHARP_){
return console.log(p1__37983_SHARP_);
});
;})(pred__37986,expr__37987))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__37990){
...
var opts = map__37991__$1;
var eval_fn = cljs.core.get.call(null,map__37991__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return (function (p1__37993_SHARP_){
return new_def.callback(p1__37993_SHARP_);
});})(new_def))
);
...
return (function (p__37994){
var vec__37995 = p__37994;
var ky = cljs.core.nth.call(null,vec__37995,(0),null);
var v = cljs.core.nth.call(null,vec__37995,(1),null);
...
if(cljs.core.truth_((function (){var and__36296__auto__ = typeof localStorage !== 'undefined';
...
}catch (e38000){if((e38000 instanceof Error)){
var e = e38000;
return not_found;
} else {
throw e38000;
...
//# sourceMappingURL=utils.js.map?rel=1518331023667
