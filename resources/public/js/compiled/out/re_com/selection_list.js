...
var base_style__$1 = (cljs.core.truth_((function (){var and__36296__auto__ = selected_QMARK_;
...
var base_style__$2 = (cljs.core.truth_((function (){var and__36296__auto__ = selected_QMARK_;
if(cljs.core.truth_(and__36296__auto__)){
...
re_com.selection_list.list_container = (function re_com$selection_list$list_container(p__41129){
...
var args = map__41130__$1;
var disabled_QMARK_ = cljs.core.get.call(null,map__41130__$1,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181));
var on_change = cljs.core.get.call(null,map__41130__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var height = cljs.core.get.call(null,map__41130__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var item_renderer = cljs.core.get.call(null,map__41130__$1,new cljs.core.Keyword(null,"item-renderer","item-renderer",-743065410));
var model = cljs.core.get.call(null,map__41130__$1,new cljs.core.Keyword(null,"model","model",331153215));
var label_fn = cljs.core.get.call(null,map__41130__$1,new cljs.core.Keyword(null,"label-fn","label-fn",-860923263));
var required_QMARK_ = cljs.core.get.call(null,map__41130__$1,new cljs.core.Keyword(null,"required?","required?",-872514462));
var as_exclusions_QMARK_ = cljs.core.get.call(null,map__41130__$1,new cljs.core.Keyword(null,"as-exclusions?","as-exclusions?",-55596285));
var max_height = cljs.core.get.call(null,map__41130__$1,new cljs.core.Keyword(null,"max-height","max-height",-612563804));
var hide_border_QMARK_ = cljs.core.get.call(null,map__41130__$1,new cljs.core.Keyword(null,"hide-border?","hide-border?",1792698922));
var width = cljs.core.get.call(null,map__41130__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var choices = cljs.core.get.call(null,map__41130__$1,new cljs.core.Keyword(null,"choices","choices",1385611597));
var id_fn = cljs.core.get.call(null,map__41130__$1,new cljs.core.Keyword(null,"id-fn","id-fn",316222798));
var multi_select_QMARK_ = cljs.core.get.call(null,map__41130__$1,new cljs.core.Keyword(null,"multi-select?","multi-select?",973156151));
...
var items = cljs.core.map.call(null,(cljs.core.truth_(item_renderer)?((function (selected,map__41130,map__41130__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,multi_select_QMARK_){
return (function (p1__41126_SHARP_){
return item_renderer.call(null,p1__41126_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__41130,map__41130__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,multi_select_QMARK_))
:(cljs.core.truth_(multi_select_QMARK_)?((function (selected,map__41130,map__41130__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,multi_select_QMARK_){
return (function (p1__41127_SHARP_){
return re_com.selection_list.as_checked.call(null,p1__41127_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__41130,map__41130__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,multi_select_QMARK_))
:((function (selected,map__41130,map__41130__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,multi_select_QMARK_){
return (function (p1__41128_SHARP_){
return re_com.selection_list.as_radio.call(null,p1__41128_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__41130,map__41130__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,multi_select_QMARK_))
)),choices);
...
var len__37479__auto___41139 = arguments.length;
var i__37480__auto___41140 = (0);
while(true){
if((i__37480__auto___41140 < len__37479__auto___41139)){
args__37486__auto__.push((arguments[i__37480__auto___41140]));

var G__41141 = (i__37480__auto___41140 + (1));
i__37480__auto___41140 = G__41141;
continue;
} else {
}
break;
...
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(argseq__37487__auto__);
});

re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic = (function (p__41133){
var map__41134 = p__41133;
var map__41134__$1 = ((((!((map__41134 == null)))?((((map__41134.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__41134.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__41134):map__41134);
var args = map__41134__$1;
if(cljs.core.truth_(((!(goog.DEBUG))?true:re_com.validate.validate_args.call(null,re_com.validate.extract_arg_data.call(null,re_com.selection_list.selection_list_args_desc),args,"selection-list")))){
} else {
throw (new Error("Assert failed: (validate-args-macro selection-list-args-desc args \"selection-list\")"));
}

return ((function (map__41134,map__41134__$1,args){
return (function() { 
var G__41142__delegate = function (p__41136){
var map__41137 = p__41136;
var map__41137__$1 = ((((!((map__41137 == null)))?((((map__41137.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__41137.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__41137):map__41137);
var args__$1 = map__41137__$1;
...
while (G__41143__i < G__41143__a.length) {G__41143__a[G__41143__i] = arguments[G__41143__i + 0]; ++G__41143__i;}
  p__41136 = new cljs.core.IndexedSeq(G__41143__a,0,null);
} 
return G__41142__delegate.call(this,p__41136);};
G__41142.cljs$lang$maxFixedArity = 0;
G__41142.cljs$lang$applyTo = (function (arglist__41144){
var p__41136 = cljs.core.seq(arglist__41144);
return G__41142__delegate(p__41136);
});
G__41142.cljs$core$IFn$_invoke$arity$variadic = G__41142__delegate;
return G__41142;
})()
;
;})(map__41134,map__41134__$1,args))
});

re_com.selection_list.selection_list.cljs$lang$maxFixedArity = (0);

re_com.selection_list.selection_list.cljs$lang$applyTo = (function (seq41132){
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq41132));
});


//# sourceMappingURL=selection_list.js.map?rel=1518491418202
