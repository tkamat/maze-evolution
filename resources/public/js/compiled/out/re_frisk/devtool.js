...
re_frisk.devtool.ie_QMARK_ = (function (){var or__36308__auto__ = cljs.core.re_find.call(null,/MSIE /,re_frisk.devtool.ua);
if(cljs.core.truth_(or__36308__auto__)){
return or__36308__auto__;
} else {
var or__36308__auto____$1 = cljs.core.re_find.call(null,/Trident\//,re_frisk.devtool.ua);
...
var expand_by_default = cljs.core.reduce.call(null,(function (p1__41403_SHARP_,p2__41404_SHARP_){
return cljs.core.assoc_in.call(null,p1__41403_SHARP_,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"data-frisk","data-frisk",-357579764),p2__41404_SHARP_,new cljs.core.Keyword(null,"expanded-paths","expanded-paths",787811540)], null),cljs.core.PersistentHashSet.createAsIfByAssoc([cljs.core.PersistentVector.EMPTY]));
...
var map__41405 = new cljs.core.Keyword(null,"prefs","prefs",-1818938470).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,re_frisk.data.deb_data));
var map__41405__$1 = ((((!((map__41405 == null)))?((((map__41405.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__41405.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__41405):map__41405);
var ext_height = cljs.core.get.call(null,map__41405__$1,new cljs.core.Keyword(null,"ext_height","ext_height",-46169089));
var ext_width = cljs.core.get.call(null,map__41405__$1,new cljs.core.Keyword(null,"ext_width","ext_width",925500566));
var w = window.open("","Debugger",["width=",cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__36308__auto__ = ext_width;
if(cljs.core.truth_(or__36308__auto__)){
return or__36308__auto__;
} else {
return (800);
}
})()),",height=",cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__36308__auto__ = ext_height;
if(cljs.core.truth_(or__36308__auto__)){
return or__36308__auto__;
} else {
return (800);
...
(w["onload"] = ((function (map__41405,map__41405__$1,ext_height,ext_width,w,d){
return (function (){
return re_frisk.devtool.mount.call(null,w,d);
});})(map__41405,map__41405__$1,ext_height,ext_width,w,d))
);
...
var len__37479__auto___41410 = arguments.length;
var i__37480__auto___41411 = (0);
while(true){
if((i__37480__auto___41411 < len__37479__auto___41410)){
args__37486__auto__.push((arguments[i__37480__auto___41411]));

var G__41412 = (i__37480__auto___41411 + (1));
i__37480__auto___41411 = G__41412;
continue;
} else {
}
break;
...
return re_frisk.devtool.re_frisk_panel.cljs$core$IFn$_invoke$arity$variadic(argseq__37487__auto__);
});

re_frisk.devtool.re_frisk_panel.cljs$core$IFn$_invoke$arity$variadic = (function (data){
var expand_by_default = cljs.core.reduce.call(null,(function (p1__41407_SHARP_,p2__41408_SHARP_){
return cljs.core.assoc_in.call(null,p1__41407_SHARP_,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"data-frisk","data-frisk",-357579764),p2__41408_SHARP_,new cljs.core.Keyword(null,"expanded-paths","expanded-paths",787811540)], null),cljs.core.PersistentHashSet.createAsIfByAssoc([cljs.core.PersistentVector.EMPTY]));
}),cljs.core.PersistentArrayMap.EMPTY,cljs.core.range.call(null,cljs.core.count.call(null,data)));
var state_atom = reagent.core.atom.call(null,expand_by_default);
return ((function (expand_by_default,state_atom){
return (function() { 
var G__41413__delegate = function (data__$1){
...
var G__41413 = function (var_args){
var data__$1 = null;
if (arguments.length > 0) {
var G__41414__i = 0, G__41414__a = new Array(arguments.length -  0);
while (G__41414__i < G__41414__a.length) {G__41414__a[G__41414__i] = arguments[G__41414__i + 0]; ++G__41414__i;}
  data__$1 = new cljs.core.IndexedSeq(G__41414__a,0,null);
} 
return G__41413__delegate.call(this,data__$1);};
G__41413.cljs$lang$maxFixedArity = 0;
G__41413.cljs$lang$applyTo = (function (arglist__41415){
var data__$1 = cljs.core.seq(arglist__41415);
return G__41413__delegate(data__$1);
});
G__41413.cljs$core$IFn$_invoke$arity$variadic = G__41413__delegate;
return G__41413;
})()
;
;})(expand_by_default,state_atom))
...
re_frisk.devtool.re_frisk_panel.cljs$lang$applyTo = (function (seq41409){
return re_frisk.devtool.re_frisk_panel.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq41409));
});

re_frisk.devtool.re_frisk_shell = (function re_frisk$devtool$re_frisk_shell(p__41416){
var map__41417 = p__41416;
var map__41417__$1 = ((((!((map__41417 == null)))?((((map__41417.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__41417.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__41417):map__41417);
var x = cljs.core.get.call(null,map__41417__$1,new cljs.core.Keyword(null,"x","x",2099068185));
var y = cljs.core.get.call(null,map__41417__$1,new cljs.core.Keyword(null,"y","y",-1757859776));
var width = cljs.core.get.call(null,map__41417__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var height = cljs.core.get.call(null,map__41417__$1,new cljs.core.Keyword(null,"height","height",1025178622));
...
var height__$1 = (cljs.core.truth_((function (){var and__36296__auto__ = re_frisk.devtool.ie_QMARK_;
if(cljs.core.truth_(and__36296__auto__)){
...
return ((function (style,height__$1,style__$1,style__$2,map__41417,map__41417__$1,x,y,width,height){
return (function (_){
...
});})(style,height__$1,style__$1,style__$2,map__41417,map__41417__$1,x,y,width,height))
...
//# sourceMappingURL=devtool.js.map?rel=1518491420085
