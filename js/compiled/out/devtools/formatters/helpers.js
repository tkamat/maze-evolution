...
var G__23097 = devtools.prefs.pref.call(null,v);
v = G__23097;
continue;
} else {
return v;
...
var and__7656__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__7656__auto__){
var and__7656__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__7668__auto__ = (function (){try{if(!((value == null))){
...
}catch (e23100){var _e__22115__auto__ = e23100;
return false;
}})();
if(cljs.core.truth_(or__7668__auto__)){
return or__7668__auto__;
} else {
var or__7668__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e23104){var _e__22115__auto__ = e23104;
return false;
}})();
...
}catch (e23106){var _e__22115__auto__ = e23106;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__7656__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__7656__auto__)){
var and__7656__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__7656__auto____$1){
...
var and__7656__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__7656__auto__)){
...
var or__7668__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__7668__auto__)){
return or__7668__auto__;
} else {
...
var and__7656__auto__ = (function (){var or__7668__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__7668__auto__)){
return or__7668__auto__;
} else {
...
var vec__23108 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__23108,(0),null);
var name = cljs.core.nth.call(null,vec__23108,(1),null);
...
var and__7656__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__7656__auto__)){
...
var or__7668__auto__ = typeof value === 'string';
if(or__7668__auto__){
return or__7668__auto__;
} else {
var or__7668__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__23111_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__23111_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1518565226069
