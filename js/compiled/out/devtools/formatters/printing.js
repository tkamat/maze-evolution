...
var len__8839__auto___23650 = arguments.length;
var i__8840__auto___23651 = (0);
while(true){
if((i__8840__auto___23651 < len__8839__auto___23650)){
args__8846__auto__.push((arguments[i__8840__auto___23651]));

var G__23652 = (i__8840__auto___23651 + (1));
i__8840__auto___23651 = G__23652;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__8847__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq23647){
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__23648,G__23649,seq23647__$2);
});
...
if(cljs.core.truth_((function (){var or__7668__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__8293__auto__,writer__8294__auto__,opt__8295__auto__){
return cljs.core._write.call(null,writer__8294__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__7656__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__7656__auto__){
var or__7668__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__7668__auto__)){
return or__7668__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__23653_SHARP_){
return !((cljs.core.meta.call(null,p1__23653_SHARP_) == null));
})))){
...
var map__23654 = opts;
var map__23654__$1 = ((((!((map__23654 == null)))?((((map__23654.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__23654.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__23654):map__23654);
var markup_db = cljs.core.get.call(null,map__23654__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__7668__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e23658){var _e__21341__auto__ = e23658;
return false;
}})();
if(cljs.core.truth_(or__7668__auto__)){
return or__7668__auto__;
...
}catch (e23660){var _e__21341__auto__ = e23660;
return false;
}}
})())){
...
var _STAR_current_state_STAR_23662 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__23663 = opts;
...
var markup_db = cljs.core.get.call(null,map__23663__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_23662;
}});
...
;
var temp__4655__auto___23667 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___23667)){
var managed_print_level_23668 = temp__4655__auto___23667;
var _STAR_print_level_STAR_23666_23669 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_23668;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_23666_23669,managed_print_level_23668,temp__4655__auto___23667,writer,opts,job_fn){
return (function (p1__23665_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__23665_SHARP_,null);
});})(_STAR_print_level_STAR_23666_23669,managed_print_level_23668,temp__4655__auto___23667,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_23666_23669;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1518330968393
