...
var len__37479__auto___53098 = arguments.length;
var i__37480__auto___53099 = (0);
while(true){
if((i__37480__auto___53099 < len__37479__auto___53098)){
args__37486__auto__.push((arguments[i__37480__auto___53099]));

var G__53100 = (i__37480__auto___53099 + (1));
i__37480__auto___53099 = G__53100;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__37487__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq53095){
var G__53096 = cljs.core.first.call(null,seq53095);
var seq53095__$1 = cljs.core.next.call(null,seq53095);
var G__53097 = cljs.core.first.call(null,seq53095__$1);
var seq53095__$2 = cljs.core.next.call(null,seq53095__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__53096,G__53097,seq53095__$2);
});
...
if(cljs.core.truth_((function (){var or__36308__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__36933__auto__,writer__36934__auto__,opt__36935__auto__){
return cljs.core._write.call(null,writer__36934__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__36296__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__36296__auto__){
var or__36308__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__36308__auto__)){
return or__36308__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__53101_SHARP_){
return !((cljs.core.meta.call(null,p1__53101_SHARP_) == null));
})))){
...
var map__53102 = opts;
var map__53102__$1 = ((((!((map__53102 == null)))?((((map__53102.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__53102.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__53102):map__53102);
var markup_db = cljs.core.get.call(null,map__53102__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__36308__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e53106){var _e__50789__auto__ = e53106;
return false;
}})();
if(cljs.core.truth_(or__36308__auto__)){
return or__36308__auto__;
...
}catch (e53108){var _e__50789__auto__ = e53108;
return false;
}}
})())){
...
var _STAR_current_state_STAR_53110 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__53111 = opts;
...
var markup_db = cljs.core.get.call(null,map__53111__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_53110;
}});
...
;
var temp__4655__auto___53115 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___53115)){
var managed_print_level_53116 = temp__4655__auto___53115;
var _STAR_print_level_STAR_53114_53117 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_53116;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_53114_53117,managed_print_level_53116,temp__4655__auto___53115,writer,opts,job_fn){
return (function (p1__53113_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__53113_SHARP_,null);
});})(_STAR_print_level_STAR_53114_53117,managed_print_level_53116,temp__4655__auto___53115,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_53114_53117;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1518330191187
