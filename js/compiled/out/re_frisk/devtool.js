...
re_frisk.devtool.ie_QMARK_ = (function (){var or__7668__auto__ = cljs.core.re_find.call(null,/MSIE /,re_frisk.devtool.ua);
if(cljs.core.truth_(or__7668__auto__)){
return or__7668__auto__;
} else {
var or__7668__auto____$1 = cljs.core.re_find.call(null,/Trident\//,re_frisk.devtool.ua);
...
var expand_by_default = cljs.core.reduce.call(null,(function (p1__29690_SHARP_,p2__29691_SHARP_){
return cljs.core.assoc_in.call(null,p1__29690_SHARP_,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"data-frisk","data-frisk",-357579764),p2__29691_SHARP_,new cljs.core.Keyword(null,"expanded-paths","expanded-paths",787811540)], null),cljs.core.PersistentHashSet.createAsIfByAssoc([cljs.core.PersistentVector.EMPTY]));
...
var map__29692 = new cljs.core.Keyword(null,"prefs","prefs",-1818938470).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,re_frisk.data.deb_data));
...
var ext_height = cljs.core.get.call(null,map__29692__$1,new cljs.core.Keyword(null,"ext_height","ext_height",-46169089));
var ext_width = cljs.core.get.call(null,map__29692__$1,new cljs.core.Keyword(null,"ext_width","ext_width",925500566));
var w = window.open("","Debugger",["width=",cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__7668__auto__ = ext_width;
if(cljs.core.truth_(or__7668__auto__)){
return or__7668__auto__;
} else {
return (800);
}
})()),",height=",cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__7668__auto__ = ext_height;
if(cljs.core.truth_(or__7668__auto__)){
return or__7668__auto__;
} else {
return (800);
...
(w["onload"] = ((function (map__29692,map__29692__$1,ext_height,ext_width,w,d){
return (function (){
return re_frisk.devtool.mount.call(null,w,d);
});})(map__29692,map__29692__$1,ext_height,ext_width,w,d))
);
...
var len__8839__auto___29697 = arguments.length;
var i__8840__auto___29698 = (0);
while(true){
if((i__8840__auto___29698 < len__8839__auto___29697)){
args__8846__auto__.push((arguments[i__8840__auto___29698]));

var G__29699 = (i__8840__auto___29698 + (1));
i__8840__auto___29698 = G__29699;
continue;
} else {
}
break;
...
return re_frisk.devtool.re_frisk_panel.cljs$core$IFn$_invoke$arity$variadic(argseq__8847__auto__);
});

re_frisk.devtool.re_frisk_panel.cljs$core$IFn$_invoke$arity$variadic = (function (data){
var expand_by_default = cljs.core.reduce.call(null,(function (p1__29694_SHARP_,p2__29695_SHARP_){
return cljs.core.assoc_in.call(null,p1__29694_SHARP_,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"data-frisk","data-frisk",-357579764),p2__29695_SHARP_,new cljs.core.Keyword(null,"expanded-paths","expanded-paths",787811540)], null),cljs.core.PersistentHashSet.createAsIfByAssoc([cljs.core.PersistentVector.EMPTY]));
}),cljs.core.PersistentArrayMap.EMPTY,cljs.core.range.call(null,cljs.core.count.call(null,data)));
var state_atom = reagent.core.atom.call(null,expand_by_default);
return ((function (expand_by_default,state_atom){
return (function() { 
var G__29700__delegate = function (data__$1){
...
while (G__29701__i < G__29701__a.length) {G__29701__a[G__29701__i] = arguments[G__29701__i + 0]; ++G__29701__i;}
  data__$1 = new cljs.core.IndexedSeq(G__29701__a,0,null);
} 
return G__29700__delegate.call(this,data__$1);};
G__29700.cljs$lang$maxFixedArity = 0;
G__29700.cljs$lang$applyTo = (function (arglist__29702){
var data__$1 = cljs.core.seq(arglist__29702);
return G__29700__delegate(data__$1);
});
...
re_frisk.devtool.re_frisk_panel.cljs$lang$applyTo = (function (seq29696){
return re_frisk.devtool.re_frisk_panel.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq29696));
});

re_frisk.devtool.re_frisk_shell = (function re_frisk$devtool$re_frisk_shell(p__29703){
...
var x = cljs.core.get.call(null,map__29704__$1,new cljs.core.Keyword(null,"x","x",2099068185));
var y = cljs.core.get.call(null,map__29704__$1,new cljs.core.Keyword(null,"y","y",-1757859776));
var width = cljs.core.get.call(null,map__29704__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var height = cljs.core.get.call(null,map__29704__$1,new cljs.core.Keyword(null,"height","height",1025178622));
...
var height__$1 = (cljs.core.truth_((function (){var and__7656__auto__ = re_frisk.devtool.ie_QMARK_;
if(cljs.core.truth_(and__7656__auto__)){
...
return ((function (style,height__$1,style__$1,style__$2,map__29704,map__29704__$1,x,y,width,height){
return (function (_){
...
});})(style,height__$1,style__$1,style__$2,map__29704,map__29704__$1,x,y,width,height))
...
//# sourceMappingURL=devtool.js.map?rel=1518565236569
