...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__9857 = cljs.core.instance_QMARK_;
var expr__9858 = reactive_val;
if(cljs.core.truth_(pred__9857.call(null,reagent.ratom.RAtom,expr__9858))){
return "ra";
} else {
if(cljs.core.truth_(pred__9857.call(null,reagent.ratom.RCursor,expr__9858))){
return "rc";
} else {
if(cljs.core.truth_(pred__9857.call(null,reagent.ratom.Reaction,expr__9858))){
return "rx";
} else {
if(cljs.core.truth_(pred__9857.call(null,reagent.ratom.Track,expr__9858))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1518330938301
