...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$h3,cljs.core.deref((function (){var G__28823 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$generation], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__28823) : re_frame.core.subscribe.call(null,G__28823));
})())], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$h3,cljs.core.deref((function (){var G__28824 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$individual], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__28824) : re_frame.core.subscribe.call(null,G__28824));
})())], null)], null);
});
...
if((row < (11))){
var G__28825 = (row + (1));
var G__28826 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(rectangles,(function (){var col = (0);
...
var G__28827 = (col + (1));
var G__28828 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(rectangles__$1,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$rect,new cljs.core.PersistentArrayMap(null, 4, [cljs.core.cst$kw$x,((30) * col),cljs.core.cst$kw$y,((30) * row),cljs.core.cst$kw$width,(30),cljs.core.cst$kw$height,(30)], null)], null));
col = G__28827;
rectangles__$1 = G__28828;
continue;
} else {
var G__28829 = (col + (1));
var G__28830 = rectangles__$1;
col = G__28829;
rectangles__$1 = G__28830;
continue;
}
} else {
...
var maze = (function (){var G__28831 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$maze_DASH_map], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__28831) : re_frame.core.subscribe.call(null,G__28831));
})();
...
var ball_position = (function (){var G__28832 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$current_DASH_position], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__28832) : re_frame.core.subscribe.call(null,G__28832));
})();
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2((function (){var fexpr__28833 = maze_evolution.views.draw_maze();
return (fexpr__28833.cljs$core$IFn$_invoke$arity$0 ? fexpr__28833.cljs$core$IFn$_invoke$arity$0() : fexpr__28833.call(null));
})(),(function (){var fexpr__28834 = maze_evolution.views.draw_ball();
return (fexpr__28834.cljs$core$IFn$_invoke$arity$0 ? fexpr__28834.cljs$core$IFn$_invoke$arity$0() : fexpr__28834.call(null));
})());
});
...
var G__28835 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$set_DASH_max_DASH_fitness_DASH_list,maze_evolution.evolution.headless_evolution_test_and_get_maximum_fitness(cljs.core.deref((function (){var G__28836 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$maze_DASH_map], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__28836) : re_frame.core.subscribe.call(null,G__28836));
})()),cljs.core.deref((function (){var G__28837 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$fitness_DASH_map], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__28837) : re_frame.core.subscribe.call(null,G__28837));
})()),cljs.core.deref((function (){var G__28838 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$generations_DASH_to_DASH_run], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__28838) : re_frame.core.subscribe.call(null,G__28838));
})()))], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__28835) : re_frame.core.dispatch.call(null,G__28835));
})], null),"Run Evolution Without Display"], null);
});
});
maze_evolution.views.input_box = (function maze_evolution$views$input_box(){
var generations_to_run = (function (){var G__28840 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$generations_DASH_to_DASH_run], null);
...
var fexpr__28842 = (function (){var G__28843 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$set_DASH_generations_DASH_to_DASH_run,p1__28839_SHARP_.target.value], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__28843) : re_frame.core.dispatch.call(null,G__28843));
})();
return (fexpr__28842.cljs$core$IFn$_invoke$arity$0 ? fexpr__28842.cljs$core$IFn$_invoke$arity$0() : fexpr__28842.call(null));
});})(generations_to_run))
], null)], null);
});
;})(generations_to_run))
...
var fitness_list = (function (){var G__28844 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$max_DASH_fitness_DASH_list], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__28844) : re_frame.core.subscribe.call(null,G__28844));
})();
...
var current_tab = (function (){var G__28845 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$tab], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__28845) : re_frame.core.subscribe.call(null,G__28845));
})();
...
var current_tab = (function (){var G__28846 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$tab], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__28846) : re_frame.core.subscribe.call(null,G__28846));
})();
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(current_tab),cljs.core.cst$kw$about)){
...
var G__28847 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$change_DASH_tab,cljs.core.cst$kw$about], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__28847) : re_frame.core.dispatch.call(null,G__28847));
...
var G__28848 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$change_DASH_tab,cljs.core.cst$kw$simulation], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__28848) : re_frame.core.dispatch.call(null,G__28848));
